<div class="content d-block d-md-flex">
  <nav class="navbar navbar-expand-md navbar-light shadow-lg bg-light d-inline-block sidebar min-vh-100 z-index-99 p-4  text-center text-md-left" style="min-width:300px ">
    <div class="navbar-control col-md-12 border-bottom d-flex align-items-center text-center justify-content-md-start justify-content-center">
      ...
      <span class="navbar-brand ml-2" href="#">Seçenekler</span>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#test" aria-controls="test" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item dropdown p-2">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <svg class="bi bi-filter-left" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="dropdown-menu position-relative w-100" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="panel/araclar/">
              ...
              <a class="dropdown-item" href="panel/araclar/arac-ekle.php">
              ...
              <a class="dropdown-item" href="panel/araclar/arac-secenekler.php">
                ...
                &emsp;Araç Seçenekleri
              </a>
              <a class="dropdown-item" href="panel/araclar/arac-secenek-ekle.php">
                <svg class="bi bi-plus" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M8 3.5a.5.5 0 01.5.5v4a.5.5 0 01-.5.5H4a.5.5 0 010-1h3.5V4a.5.5 0 01.5-.5z" clip-rule="evenodd"/>
                  <path fill-rule="evenodd" d="M7.5 8a.5.5 0 01.5-.5h4a.5.5 0 010 1H8.5V12a.5.5 0 01-1 0V8z" clip-rule="evenodd"/>
                </svg>
                &emsp;Araç Seçeneği Ekle
              </a>
              <a class="dropdown-item" href="panel/araclar/arac-kirala.php">
                <svg class="bi bi-plus" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M8 3.5a.5.5 0 01.5.5v4a.5.5 0 01-.5.5H4a.5.5 0 010-1h3.5V4a.5.5 0 01.5-.5z" clip-rule="evenodd"/>
                  <path fill-rule="evenodd" d="M7.5 8a.5.5 0 01.5-.5h4a.5.5 0 010 1H8.5V12a.5.5 0 01-1 0V8z" clip-rule="evenodd"/>
                </svg>
              ...
              <a class="dropdown-item" href="panel/araclar/kiralamalar.php">
          ...
          <li class="nav-item dropdown p-2">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <svg class="bi bi-chat-quote-fill" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="dropdown-menu position-relative w-100" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="panel/mesajlar/">
              ...
              <a class="dropdown-item" href="panel/mesajlar/okunmus-mesajlar.php">
                <svg class="bi bi-check" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 010 .708l-7 7a.5.5 0 01-.708 0l-3.5-3.5a.5.5 0 11.708-.708L6.5 10.293l6.646-6.647a.5.5 0 01.708 0z" clip-rule="evenodd"/>
                </svg>
                &emsp;Okunmuş Mesajlar
              </a>
            </div>
          </li>
          <li class="nav-item dropdown p-2">
            ...
            <div class="dropdown-menu position-relative w-100" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="panel/musteriler/">
                <svg class="bi bi-card-heading" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 00-.5.5v9a.5.5 0 00.5.5h13a.5.5 0 00.5-.5v-9a.5.5 0 00-.5-.5zm-13-1A1.5 1.5 0 000 3.5v9A1.5 1.5 0 001.5 14h13a1.5 1.5 0 001.5-1.5v-9A1.5 1.5 0 0014.5 2h-13z" clip-rule="evenodd"/>
                  <path fill-rule="evenodd" d="M3 8.5a.5.5 0 01.5-.5h9a.5.5 0 010 1h-9a.5.5 0 01-.5-.5zm0 2a.5.5 0 01.5-.5h6a.5.5 0 010 1h-6a.5.5 0 01-.5-.5z" clip-rule="evenodd"/>
                  <path d="M3 5.5a.5.5 0 01.5-.5h9a.5.5 0 01.5.5v1a.5.5 0 01-.5.5h-9a.5.5 0 01-.5-.5v-1z"/>
              ...
              <a class="dropdown-item" href="panel/musteriler/musteri-ekle.php">
                <svg class="bi bi-plus" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M8 3.5a.5.5 0 01.5.5v4a.5.5 0 01-.5.5H4a.5.5 0 010-1h3.5V4a.5.5 0 01.5-.5z" clip-rule="evenodd"/>
                  <path fill-rule="evenodd" d="M7.5 8a.5.5 0 01.5-.5h4a.5.5 0 010 1H8.5V12a.5.5 0 01-1 0V8z" clip-rule="evenodd"/>
                </svg>
          ...
          <li class="nav-item dropdown p-2">
            ...
            <div class="dropdown-menu position-relative w-100" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="panel/kullanici/">
                ...
                &emsp;Bilgileri Güncelle
              </a>
              <a class="dropdown-item" href="panel/kullanici/sifre-guncelle.php">
                ...
                &emsp;Şifreyi Değiştir
              </a>
            </div>
          </li>
          <li class="nav-item p-2">
            <a class="nav-link active" href="panel/kodlar.php">
              <svg class="bi bi-box-arrow-in-down" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
